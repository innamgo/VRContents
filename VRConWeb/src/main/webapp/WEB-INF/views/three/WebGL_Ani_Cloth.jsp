...
<title>Insert title here</title>
	...
	<body>
		...
		<script src="/resources/three/js/Detector.js"></script>
		<script src="/resources/three/js/libs/stats.min.js"></script>

		<script src="/resources/three/js/Cloth.js"></script>
		...
		<script>
			...
			function init() {
				...
				var clothTexture = THREE.ImageUtils.loadTexture( '/resources/three/textures/patterns/circuit_pattern.png' );
				...
				var groundTexture = THREE.ImageUtils.loadTexture( "/resources/three/textures/terrain/grasslight-big.jpg" );
